...
export const translations: { en: TranslationContent; fa: TranslationContent } = {
  ...
  fa: {
    ...
    profileText: "توسعه‌دهنده پویا و خودآموز با تخصص در راهکارهای نوآورانه Web3 و رمزارزها. بهره‌گیری از ابزارهای هوش مصنوعی برای بهینه‌سازی جریان‌های کاری توسعه در زبان‌های برنامه‌نویسی متنوع. دانش عمیق در فناوری‌های بلاکچین و پروتکل‌های رمزنگاری بر روی پلتفرم‌هایی مانند اتریوم، بایننس اسمارت چین، سولانا، ترون و بیت‌کوین. یادگیرنده‌ای سریع با قابلیت انطباق بالا با فناوری‌های نوظهور. سابقه اثبات‌شده در ساخت برنامه‌های کاربردی مقیاس‌پذیر فول‌استک با React.js، Next.js، Node.js و NestJS. متعهد به ارائه راهکارهای کارآمد و مشتاق برای چالش‌های پیچیده توسعه.",
